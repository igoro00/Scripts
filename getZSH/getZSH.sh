...
echo "# Generated by Powerlevel10k configuration wizard on 2020-03-15 at 00:19 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=136
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=15
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=24

  # Context format when running with privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='ﲵ %n'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='爵%n'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n'

  typeset -g POWERLEVEL9K_HOST_TEMPLATE="%m"
  typeset -g POWERLEVEL9K_HOST_FOREGROUND=15
  typeset -g POWERLEVEL9K_HOST_BACKGROUND=39
...
'builtin' 'unset' 'p10k_config_opts'" > ~/.p10k.zsh
